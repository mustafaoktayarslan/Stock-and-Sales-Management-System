...
namespace MarketSystem
{
    public partial class Alert : Form
    {
        ...
        public void showAlert(string msg)
        {
            ...
            for (int i = 1; i < 10; i++)
            {
                ...
                if (frm == null)
                {
                    ...
                    this.y = Screen.PrimaryScreen.WorkingArea.Height - (this.Height * i) - (5 * (i + 1));
        ...
        private void btnReorder_Click(object sender, EventArgs e)
        {
            ...
            stock.ProductForSupplier(lblBarcode.Text,main.lblName.Text);
            stockIn.addStockIn(lblBarcode.Text);
        }
